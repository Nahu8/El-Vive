...
export class ApiService {
  ...
  uploadHeroVideoDomLight(file: File): Observable<any> {
    const formData = new FormData();
    formData.append('video', file);
    return this.http.post<any>(`${this.apiUrl}/home/video-dom-light`, formData);
  }
  deleteHeroVideoDomLight(): Observable<any> { return this.http.delete<any>(`${this.apiUrl}/home/video-dom-light`); }
  uploadHeroVideoDomDark(file: File): Observable<any> {
    const formData = new FormData();
    formData.append('video', file);
    return this.http.post<any>(`${this.apiUrl}/home/video-dom-dark`, formData);
  }
  deleteHeroVideoDomDark(): Observable<any> { return this.http.delete<any>(`${this.apiUrl}/home/video-dom-dark`); }
  uploadHeroVideoMierLight(file: File): Observable<any> {
    const formData = new FormData();
    formData.append('video', file);
    return this.http.post<any>(`${this.apiUrl}/home/video-mier-light`, formData);
  }
  deleteHeroVideoMierLight(): Observable<any> { return this.http.delete<any>(`${this.apiUrl}/home/video-mier-light`); }
  uploadHeroVideoMierDark(file: File): Observable<any> {
    const formData = new FormData();
    formData.append('video', file);
    return this.http.post<any>(`${this.apiUrl}/home/video-mier-dark`, formData);
  }
  deleteHeroVideoMierDark(): Observable<any> { return this.http.delete<any>(`${this.apiUrl}/home/video-mier-dark`); }
  ...
  uploadIconDomLight(file: File): Observable<any> {
    const fd = new FormData();
    fd.append('icon', file);
    return this.http.post<any>(`${this.apiUrl}/home/icon-dom-light`, fd);
  }
  deleteIconDomLight(): Observable<any> { return this.http.delete<any>(`${this.apiUrl}/home/icon-dom-light`); }
  uploadIconDomDark(file: File): Observable<any> {
    const fd = new FormData();
    fd.append('icon', file);
    return this.http.post<any>(`${this.apiUrl}/home/icon-dom-dark`, fd);
  }
  deleteIconDomDark(): Observable<any> { return this.http.delete<any>(`${this.apiUrl}/home/icon-dom-dark`); }
  uploadIconMierLight(file: File): Observable<any> {
    const fd = new FormData();
    fd.append('icon', file);
    return this.http.post<any>(`${this.apiUrl}/home/icon-mier-light`, fd);
  }
  deleteIconMierLight(): Observable<any> { return this.http.delete<any>(`${this.apiUrl}/home/icon-mier-light`); }
  uploadIconMierDark(file: File): Observable<any> {
    const fd = new FormData();
    fd.append('icon', file);
    return this.http.post<any>(`${this.apiUrl}/home/icon-mier-dark`, fd);
  }
  deleteIconMierDark(): Observable<any> { return this.http.delete<any>(`${this.apiUrl}/home/icon-mier-dark`); }
  ...
  updateGenericPage(pageKey: string, pageContent: any): Observable<any> {
  ...
  uploadMinistryPdf(ministryId: string, file: File): Observable<any> {
    const fd = new FormData();
    fd.append('pdf', file);
    return this.http.post<any>(`${this.apiUrl}/ministry/${ministryId}/pdf`, fd);
  }

  deleteMinistryPdf(ministryId: string): Observable<any> {
